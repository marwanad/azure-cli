...
from ._validators import (
    validate_cluster_autoscaler_params, validate_create_parameters, validate_k8s_client_version, validate_k8s_version,
    validate_linux_host_name, validate_list_of_integers, validate_ssh_key, validate_connector_name, validate_max_pods,
    validate_nodes_count, validate_nodepool_name, validate_vm_set_type, validate_load_balancer_sku,
    validate_load_balancer_outbound_ips, validate_load_balancer_outbound_ip_prefixes, validate_taints, validate_ip_ranges,
    validate_acr)
...
def load_arguments(self, _):
    ...
    with self.argument_context('aks create') as c:
        ...
        c.argument('cluster_autoscaler_params', nargs='+', validator=validate_cluster_autoscaler_params)
